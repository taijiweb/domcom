var Component, List, Tag, Text, TransformComponent, a, accordion, accordionGroup, bind, case_, comp, demo2Node, div, dontUnmount, each, every, expect, func, funcEach, idescribe, if_, iit, isComponent, list, ndescribe, newDemoNode, nit, p, pour, see, span, text, txt;

({expect, iit, idescribe, nit, ndescribe, newDemoNode} = require('bdd-test-helper'));

({newDemoNode} = require('./helper'));

({isComponent, Component, TransformComponent, Tag, Text, txt, list, List, func, if_, case_, func, each, every, funcEach, accordionGroup, accordion, a, p, span, text, div, bind, pour, see} = dc);
