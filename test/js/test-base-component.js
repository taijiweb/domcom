var Html, List, Nothing, Tag, Text, a_, bindings, classFn, div, expect, html, idescribe, iit, list, ndescribe, newDemoNode, nit, p, see, styleFrom, txt;

({expect, iit, idescribe, nit, ndescribe, newDemoNode} = require('bdd-test-helper'));

({newDemoNode} = require('./helper'));

({bindings, see, Tag, Text, List, txt, list, p, div, Html, html, classFn, styleFrom, Nothing} = dc);
