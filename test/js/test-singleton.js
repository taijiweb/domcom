var Component, If, Tag, Text, TransformComponent, a, case_, div, expect, flow, forceCase, forceIf, func, idescribe, if_, iit, list, ndescribe, newDemoNode, nit, p, pick, see, span, text, txt;

({expect, iit, idescribe, nit, ndescribe, newDemoNode} = require('bdd-test-helper'));

({newDemoNode} = require('./helper'));

({see, flow, Component, TransformComponent, Tag, Text, txt, list, func, if_, forceIf, If, case_, forceCase, func, pick, a, p, span, text, div} = dc);
