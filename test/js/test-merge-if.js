var Component, If, List, Tag, Text, a, div, expect, flow, func, idescribe, if_, iit, list, mergeIf, ndescribe, newDemoNode, nit, p, see, span, text, txt;

({expect, iit, idescribe, nit, ndescribe, newDemoNode} = require('bdd-test-helper'));

({newDemoNode} = require('./helper'));

({see, flow, Component, Tag, Text, List, If, txt, list, func, if_, mergeIf, a, p, span, text, div} = dc);
