...
/**test-directive
 */
var $hide, $show, $splitter, Component, a, a$, bindings, ddescribe, div, duplex, each, expect, func, idescribe, if_, iit, input, list, ndescribe, nit, p, see, select, span, text, _ref;
