...
gulp.task 'coffee', (cb) ->
  ...
  streamList.push compileCoffee('./scripts/**/*.coffee', './scripts-js')
  streamList.push compileCoffee('./test/**/*.coffee', './test/js')
  streamList.push compileCoffee('./demo/**/*.coffee', './demo/js')
