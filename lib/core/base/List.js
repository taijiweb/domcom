var BaseComponent, List, binaryInsert, binarySearch, checkConflictOffspring, checkContainer, exports, newLine, substractSet, toComponent, toComponentList, _ref,
...
module.exports = exports = List = (function(_super) {
  ...
  List.prototype.createDom = function() {
    ...
    if (!length) {
      this.emptyTextNode = node = document.createTextNode('');
      this.node = node;
      this.firstNode = node;
      return node;
    } else {
