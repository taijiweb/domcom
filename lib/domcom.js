...
extend(dc, require('dc-util'), require('./config'), require('./dom-util'), require('./dc-update'), require('./core/index'), require('./dc-error'));

extend(dc, dc.builtinDirectives = require('./directives/index'));

extend(dc, require('./core/property/delegate-event'), require('./core/property/css-arith'));
